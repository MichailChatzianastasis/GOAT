...
def load_data(path="./data/cora/", dataset="cora"):
    ...
    if(dataset=="cora"):
        ...
        print("Only cora and citeseer datasets are currently supported. EXIT!")
        exit()
    ...
    #idx_test = range(1708, 1708+1000)
    if(dataset=="citeseer"):
        idx_test = open("./data/citeseer/ind.citeseer.test.index").read().splitlines()
